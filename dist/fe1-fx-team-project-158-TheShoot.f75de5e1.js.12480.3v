document.addEventListener("DOMContentLoaded", ()=>{
    ...
    document.addEventListener("click", (e)=>{
        if (!toggleButton.contains(e.target) && !dropdown.contains(e.target)) dropdown.style.display = "none";
    });
});
// dialog
...
//# sourceMappingURL=fe1-fx-team-project-158-TheShoot.f75de5e1.js.map
